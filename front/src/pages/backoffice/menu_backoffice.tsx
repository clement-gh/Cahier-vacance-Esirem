            ...
            <main>
                <NavBar/>
                    ...
                    <section className="menu_backoffice_blocs_courses">
                        <BlocCourse title="Gestion des utilisateurs" link="/backoffice/gestion_utilisateurs" imgAdd="/images/pexels-photo-459653.jpeg" imgAlt="background_bloc_informatique" iconAdd="/images/computer.png"iconAlt="computer_icon"/>
