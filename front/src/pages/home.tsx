        ...
        return (
            <main id="home_page">
                ...
                <section className="home_page_blocs_courses">
                    <BlocCourse title="Informatique" link="/matieres" imgAdd="./images/pexels-photo-459653.jpeg" imgAlt="background_bloc_informatique" iconAdd="./images/computer.png"iconAlt="computer_icon"/>
                    <BlocCourse title="Mathématique" link="/matieres" imgAdd="./images/background_maths.png" imgAlt="background_bloc_maths" iconAdd="./images/logoMaths.png"iconAlt="maths_icon"/>
                    <BlocCourse title="Électronique" link="/matieres" imgAdd="./images/background_elec.png" imgAlt="background_bloc_informatique" iconAdd="./images/logoElectronique.png"iconAlt="elec_icon"/>
                </section>
                <Footer/>
            </main>
        );
